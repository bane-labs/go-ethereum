...
var LayoutNames = []string{LayoutNameByEpoch}
...
func newLayout(name string, fs afero.Fs, cache *blobStorageSummaryCache, pruner *blobPruner, retain primitives.Epoch) (fsLayout, error) {
	switch name {
	case LayoutNameByEpoch:
		return newPeriodicEpochLayout(fs, cache, pruner, retain), nil
	default:
