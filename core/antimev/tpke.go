...
func (tkg *thresholdKeyGroup) encrypt(msg *bls12381.PointG1) (*tpke.CipherText, error) {
...
func (tkg *thresholdKeyGroup) aggregateAndDecrypt(cts []*tpke.CipherText, inputs map[int]([]*tpke.DecryptionShare), threshold int, scaler int) ([]*bls12381.PointG1, error) {
