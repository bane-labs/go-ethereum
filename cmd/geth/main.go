...
var (
	...
	nodeFlags = slices.Concat([]cli.Flag{
		...
		utils.OneMsgR1CSPathFlag,
		utils.TwoMsgR1CSPathFlag,
		utils.SevenMsgR1CSPathFlag,
		utils.OneMsgProvingKeyPathFlag,
		utils.TwoMsgProvingKeyPathFlag,
		utils.SevenMsgProvingKeyPathFlag,
		utils.NATFlag,
	...
	}, utils.NetworkFlags, utils.DatabaseFlags, utils.BlobStorageFlags)
