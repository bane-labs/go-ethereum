...
func (c *ChainConfig) Description() string {
	...
	if c.NeoXEthSigBlock != nil {
		banner += fmt.Sprintf(" - NeoXEthSigBlock:             #%-8v\n", c.NeoXEthSigBlock)
	}
	if c.CancunTime != nil {
...
func (c *ChainConfig) checkCompatible(newcfg *ChainConfig, headNumber *big.Int, headTimestamp uint64) *ConfigCompatError {
	...
	if isForkBlockIncompatible(c.NeoXDKGBlock, newcfg.NeoXDKGBlock, headNumber) {
		return newBlockCompatError("NeoXDKGBlock fork block", c.NeoXDKGBlock, newcfg.NeoXDKGBlock)
	}
	...
	if isForkBlockIncompatible(c.NeoXEthSigBlock, newcfg.NeoXEthSigBlock, headNumber) {
		return newBlockCompatError("NeoXEthSigBlock fork block", c.NeoXEthSigBlock, newcfg.NeoXEthSigBlock)
	}
